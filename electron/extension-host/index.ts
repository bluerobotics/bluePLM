...
// Host
export { ExtensionHost, createExtensionHost, initializeExtensionHost } from './host'
...
// Sandbox
export { ExtensionSandbox, SandboxManager, createSandboxManager } from './sandbox'

// Watchdog
export { Watchdog, createWatchdog } from './watchdog'

// IPC
export { ExtensionHostIPC, createExtensionHostIPC, createIPCBridgedAPI } from './ipc'
