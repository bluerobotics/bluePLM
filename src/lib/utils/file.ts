...
export function getFileIconType(extension: string): FileIconType {
  ...
  // Archives
  if (
    ['.zip', '.rar', '.7z', '.tar', '.gz', '.bz2', '.xz', '.zst', '.tgz', '.tbz2'].includes(ext)
  ) {
    return 'archive'
  }
