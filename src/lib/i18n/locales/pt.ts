...
export const pt: TranslationDict = {
  mdbSetup: {
    ...
    existing: 'Ligar a um servidor MDB existente',
    existingHelp: 'Introduza apenas o endereço HTTPS público.',
    install: 'Configurar um novo servidor MDB',
    installHelp: 'Implementação FTPS guiada com segredos privados e cofre de rede.',
    backendUrl: 'URL do backend',
    publicUrl: 'URL HTTPS pública',
    connect: 'Ligar ao MariaDB (MDB)',
    deployed: 'Servidor MDB implementado',
    deployedHelp: 'O pacote do servidor e a configuração privada foram carregados.',
    openSetup: 'Abrir configuração do servidor',
    completed: 'Configuração concluída — ligar BluePLM',
    newServer: 'Configurar um novo servidor BluePLM MDB',
    hosting: 'Preparação do alojamento',
    addressAndFtp: 'Endereço público e FTP/FTPS',
    database: 'Ligação MariaDB para o servidor PHP',
    secrets: 'Segredos da instalação inicial',
    networkVault: 'Caminho do cofre arquivo/NAS',
    browse: 'Procurar pastas…',
    storeSecrets: 'Guardar segredos gerados',
    generatedHelp: 'São mostrados uma vez e não ficam guardados no cliente.',
    sessionComment: 'segredo de sessão',
    bootstrapComment: 'token de arranque',
    maintenanceComment: 'token de manutenção',
    vaultHelp: 'Escolha a raiz do arquivo ou NAS.',
    browseFolders: 'Procurar pastas…',
    finishGuided: 'Concluir configuração guiada',
    guidedStep1: 'Abra a página de configuração e introduza o token.',
    guidedStep2: 'Crie a empresa, proprietário, cofre NAS e proteção opcional.',
    guidedStep3: 'Volte aqui após o sucesso.',
    openServerSetup: 'Abrir configuração',
    checkServer: 'A verificar servidor MDB…',
    connectAfterSetup: 'Configuração concluída — ligar BluePLM',
    hostingPreparation: '1. Preparação do alojamento',
    hostingHelp: 'Crie o utilizador FTP e a base MariaDB.',
    documentRootConfirmed: 'Confirmei que a raiz aponta para public/.',
    addressFtp: '2. Endereço público e FTP/FTPS',
    publicHttps: 'URL HTTPS pública',
    ftpServer: 'URL do servidor FTP/FTPS',
    ftpTarget: 'Pasta FTP',
    ftpTargetPlaceholder: 'deixe vazio para a raiz do utilizador FTP',
    ftpUser: 'Utilizador FTP',
    ftpPassword: 'Palavra-passe FTP',
    databaseConnection: '3. Ligação MariaDB',
    databaseHost: 'Host da base de dados',
    port: 'Porta',
    databaseName: 'Nome da base de dados',
    databaseUser: 'Utilizador da base de dados',
    databasePassword: 'Palavra-passe da base de dados',
    firstSecrets: '4. Segredos iniciais',
    generateSecrets: 'Gerar segredos seguros',
    secretsHelp: 'Os valores são escritos apenas no .env privado.',
  ...
  setup: {
    backendChooser: 'Escolha o fornecedor backend para este cliente BluePLM.',
    mdbDescription:
      'API PHP e MariaDB. O BluePLM mantém disponíveis todas as funções independentes do backend.',
