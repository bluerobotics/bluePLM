...
export async function handleMembers(addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to list members: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleInvite(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    const { error } = await supabase.from('pending_org_members').insert({
    ...
    addOutput(
      'success',
      `Invited ${email} as ${role}${teamIds.length ? ` (team: ${teamName})` : ''}`,
    )
    addOutput('info', 'User will see this organization when they sign in with this email.')
  } catch (error) {
    addOutput('error', `Failed to invite: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleRemoveMember(
  ...
  try {
    ...
    addOutput('error', `Failed to remove member: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleTeams(addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to list teams: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleCreateTeam(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to create team: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleDeleteTeam(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to delete team: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleAddToTeam(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const email = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to add to team: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleRemoveFromTeam(
  ...
  try {
    ...
    addOutput('error', `Failed to remove from team: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleTeamInfo(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    const members = (team.team_members as any[]) || [] // TODO: type this
    ...
    const perms = (team.team_permissions as any[]) || [] // TODO: type this
    ...
    addOutput('error', `Failed to get team info: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleRoles(addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to list roles: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleCreateRole(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to create role: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleDeleteRole(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to delete role: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleAssignRole(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const email = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to assign role: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleUnassignRole(
  ...
  try {
    ...
    addOutput('error', `Failed to unassign role: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handleTitles(addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to list titles: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleCreateTitle(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to create title: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleSetTitle(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const email = parsed.args[0]
  ...
  try {
    ...
    await supabase.from('user_job_titles').delete().eq('user_id', targetUser.id)

    // Set new title
    const { error } = await supabase.from('user_job_titles').insert({
      user_id: targetUser.id,
      title_id: title.id,
      assigned_by: user.id,
    })
    ...
    addOutput('error', `Failed to set title: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleDeleteTitle(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const name = parsed.args[0]
  ...
  try {
    ...
    if (count && count > 0) {
      ...
      if (!force) {
        addOutput(
          'error',
          `Title "${title.name}" is assigned to ${count} user${count > 1 ? 's' : ''}. Use --force to delete anyway.`,
        )
        return
      }

      // Remove all assignments first
      await supabase.from('user_job_titles').delete().eq('title_id', title.id)
    }

    // Delete the title
    const { error } = await supabase.from('job_titles').delete().eq('id', title.id)

    if (error) throw error

    addOutput('success', `Deleted job title: ${title.name}`)
  } catch (error) {
    addOutput('error', `Failed to delete title: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handlePermissions(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput('error', `Failed to get permissions: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleGrant(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const teamName = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to grant permission: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleRevoke(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const teamName = parsed.args[0]
  const resource = parsed.args[1]
  const action = parsed.args[2]
  ...
  try {
    ...
    addOutput('error', `Failed to revoke permission: ${error instanceof Error ? error.message : error}`)
  }
}
 ...
 */
export async function handleUserInfo(parsed: ParsedCommand, addOutput: OutputFn): Promise<void> {
  const email = parsed.args[0]
  ...
  try {
    ...
    addOutput('error', `Failed to get user info: ${error instanceof Error ? error.message : error}`)
  }
}
...
export async function handlePendingInvites(addOutput: OutputFn): Promise<void> {
  ...
  try {
    ...
    addOutput(
      'error',
      `Failed to list pending invites: ${error instanceof Error ? error.message : error}`,
    )
  }
}
