...
export function eventMatches(
  ...
  switch (registered.type) {
    ...
    case 'onCommand':
      return (
        (trigger as { type: 'onCommand'; commandId: string }).commandId === registered.commandId
      )
    ...
    case 'onFileType':
      return (
        (trigger as { type: 'onFileType'; extension: string }).extension.toLowerCase() ===
        registered.extension.toLowerCase()
      )
