...
export const MODULE_RESOURCES: ResourceDefinition[] = [
  ...
  // Production
  {
    id: 'module:manufacturing-orders',
  ...
  {
    id: 'module:travellers',
    name: 'Travellers',
    description: 'Shop floor travellers',
    category: 'modules',
    icon: 'ScrollText',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:work-instructions',
    name: 'Work Instructions',
    description: 'Assembly and work instructions',
    category: 'modules',
    icon: 'BookOpen',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:yield-tracking',
    name: 'Yield Tracking',
    description: 'Production yield analytics',
    category: 'modules',
    icon: 'TrendingUp',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:error-codes',
    name: 'Error Codes',
    description: 'Error code management',
    category: 'modules',
    icon: 'AlertOctagon',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:scrap-tracking',
    name: 'Scrap Tracking',
    description: 'Scrap and waste tracking',
    category: 'modules',
    icon: 'Trash',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:imr',
    name: 'Incoming Material Reports',
    description: 'IMR management',
    category: 'modules',
    icon: 'PackageSearch',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:scar',
    name: 'Supplier Corrective Actions',
  ...
  {
    id: 'module:quality-templates',
    name: 'Quality Templates',
    description: 'Quality document templates',
    category: 'modules',
    icon: 'FileStack',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
  ...
  {
    id: 'module:general-ledger',
    name: 'General Ledger',
    description: 'GL management',
    category: 'modules',
    icon: 'BookOpen',
    applicableActions: ['view', 'create', 'edit', 'delete', 'admin'],
    defaultActions: [],
