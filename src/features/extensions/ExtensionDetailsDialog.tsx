        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {isNative && (
            <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/30">
              ...
              <p className="text-sm text-purple-300">
                This extension runs in the main process and has full system access. Only install
                native extensions from trusted sources.
              </p>
            </div>
          )}
          ...
          {verification === 'sideloaded' && (
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-red-300">
                This extension was installed from a local file and has not been reviewed. Use at
                your own risk.
              </p>
            </div>
          )}
          ...
          {isInstalled && installed && (
            <div>
              ...
              {installed.error && <p className="mt-2 text-sm text-red-400">{installed.error}</p>}
