  ...
  if (type === 'no-results') {
    return (
      <div className="p-6 text-center">
        ...
        <div className="text-xs text-plm-fg-muted mt-1">Try a different filter or search term</div>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 text-center">
      ...
      <div className="text-xs text-plm-fg-muted mt-2 space-y-1">
        <p>
          Use filters like <code className="px-1 bg-plm-bg-light rounded">pn:123</code> for part
          numbers
        </p>
        <p>
          or <code className="px-1 bg-plm-bg-light rounded">eco:ECO-001</code> for ECO files
        </p>
        {isGdriveConnected && (
          <p>
            or <code className="px-1 bg-plm-bg-light rounded">drive:file</code> for Google Drive
          </p>
        )}
      </div>
    </div>
