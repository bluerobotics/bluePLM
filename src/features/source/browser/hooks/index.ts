/**
 * FileBrowser Hooks - Barrel Export
 * 
 * This module provides all hooks for the FileBrowser component organized by category.
 ...
 * - `useFileBrowserOperations` - Groups operation-related hooks
 * - `useFileBrowserView` - Groups view-related state hooks
 * 
...
export { useFileBrowserView } from './useFileBrowserView'