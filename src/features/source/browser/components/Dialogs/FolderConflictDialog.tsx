      ...
      >
        ...
        <div className="bg-plm-bg rounded border border-plm-border mb-4 p-3">
          ...
          <p className="text-sm text-plm-fg-dim">
            A folder with this name already exists in{' '}
            <span className="font-medium">{displayTargetPath}</span>
          </p>
        </div>

        <p className="text-sm text-plm-fg-dim mb-4">How would you like to handle this conflict?</p>
