...
export const NoVaultEmptyState = memo(function NoVaultEmptyState() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
      ...
      <h3 className="text-lg font-semibold text-plm-fg mb-2">No Vault Connected</h3>
      <p className="text-sm text-plm-fg-muted max-w-[280px] mb-6">
        Connect to a vault to browse and manage your files
      </p>
      <button onClick={handleGoToVaultSettings} className="btn btn-primary flex items-center gap-2">
        <Settings size={16} />
