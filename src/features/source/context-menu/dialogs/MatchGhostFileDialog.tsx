    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-plm-fg">Match Ghost File</h3>
        ...
        {hasCandidates ? (
              ...
              {candidates.map((candidate, i) => (
                <label
                  ...
                  className={`flex items-center gap-3 px-3 py-2 cursor-pointer hover:bg-plm-bg-light transition-colors ${
                    i === selectedIndex
                      ? 'bg-plm-accent/10 border-l-2 border-l-plm-accent'
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      <span
                        className="text-xs text-plm-fg-dim truncate"
          ...
          <div className="bg-plm-warning/10 border border-plm-warning/30 rounded p-3 mb-4">
            ...
            <p className="text-xs text-plm-fg-muted mt-1">
              No unmatched local files with the same extension were found in the same folder. The
              renamed file may be in a different folder or not yet added locally.
            </p>
          </div>
        )}
