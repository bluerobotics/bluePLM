...
// Note: FileIcon is now used inside file-browser/ListRowIcon.tsx
import { 
  supabase,
  updateFileMetadata, 
  isWatchingFile
...
// NOTE: FileIconCard and ListRowIcon components have been extracted to file-browser/
...
export function FileBrowser({ onRefresh }: FileBrowserProps) {
  ...
  // Note: hover states are now provided via FileBrowserContext to CellRenderer
