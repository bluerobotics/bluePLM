...
Supabase option. The MDB integration supports a Windows network vault for
archive files. Google Drive is intentionally deferred from this upstream
integration until it has been validated separately.
